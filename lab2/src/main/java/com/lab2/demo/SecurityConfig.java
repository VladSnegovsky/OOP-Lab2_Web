...
public class SecurityConfig extends KeycloakWebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/noorders").permitAll()
                .antMatchers(HttpMethod.POST, "/order").permitAll()
                .antMatchers(HttpMethod.POST, "/menu").permitAll()
                .antMatchers(HttpMethod.POST, "/paid").permitAll()
                .antMatchers(HttpMethod.GET, "/receipt").permitAll()
                .antMatchers(HttpMethod.POST, "/receipt").permitAll()
                .antMatchers(HttpMethod.POST, "/redept").permitAll()
                .antMatchers(HttpMethod.GET, "/redept").permitAll()
                .antMatchers(HttpMethod.GET, "/part").permitAll()
                .antMatchers(HttpMethod.POST, "/part").permitAll()
                .and()
                .logout()
